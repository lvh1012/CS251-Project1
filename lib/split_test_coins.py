...
if __name__ == '__main__':
    ...
    private_key = CBitcoinSecret('cRtpE9kjGXjngWhrPDtGRW3pSeU3otTt9QyPQfUQCszoAXQjPp5H')
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.00009 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = ('58172bb2d7eb3599fc617bbfec9ee2551ec0c3825883190f9914b0965c5aa2d5')
